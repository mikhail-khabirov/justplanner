                            ...
                            <tr>
                                <td style="padding: 28px 28px 24px; text-align: center;">
                                    ...
                                    <table role="presentation" cellpadding="0" cellspacing="0" style="margin: 0 auto 16px;">
                                        <tr>
                                            <td style="font-size: 16px; color: rgba(255,255,255,0.7); text-decoration: line-through; padding-right: 12px;">3 588 ₽/год</td>
                                            <td style="font-size: 24px; font-weight: 800; color: #ffffff;">1 794 ₽/год</td>
                                        </tr>
                                    </table>
                                    ...
                                    <div style="font-size: 12px; color: rgba(255,255,255,0.7); margin-top: 12px;">Это всего 149 ₽/мес вместо 299 ₽/мес</div>
                                </td>
                            </tr>
                        </table>
                    </td>
    ...
    <tr>
        <td align="center">
            <table role="presentation" width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 24px rgba(0,0,0,0.08);">
                ...
                <tr>
                    <td style="padding: 24px 40px 0;">
                        <p style="margin: 0; font-size: 15px; color: #64748b; line-height: 1.6;">После истечения срока цена вернётся к стандартной — 299 ₽/мес (3 588 ₽/год).</p>
                    </td>
                </tr>
                <tr>
