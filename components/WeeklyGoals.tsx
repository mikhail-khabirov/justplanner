...
import { Target, Plus, X, GripVertical, Check, ArrowRightToLine, ChevronDown, ChevronRight, Sparkles } from 'lucide-react';
        ...
        <>
            ...
            >
                <div className="h-full bg-white shadow-2xl flex flex-col border-r border-gray-100">
                    ...
                    {/* Onboarding intro */}
                    {showIntro && (
                        <div className="mx-3 mt-2 mb-1 p-3 rounded-xl border" style={{ borderColor: '#26A69A40', backgroundColor: '#26A69A08' }}>
                            <div className="flex items-start gap-2">
                                <Sparkles size={16} className="flex-shrink-0 mt-0.5" style={{ color: '#26A69A' }} />
                                <div className="flex-1">
                                    <p className="text-xs font-semibold text-gray-700 mb-1.5">Планируйте неделю!</p>
                                    <ul className="text-[11px] text-gray-500 space-y-1 leading-relaxed">
                                        <li>📌 Запишите ключевые цели на неделю</li>
                                        <li>📋 Раскройте цель и добавьте подзадачи</li>
                                        <li>➡️ Переносите незавершённое на следующую неделю одной кнопкой</li>
                                        <li>↕️ Перетаскивайте цели, чтобы расставить приоритеты</li>
                                    </ul>
                                </div>
                            </div>
                            <button
                                onClick={onDismissIntro}
                                className="mt-2.5 w-full py-1.5 rounded-lg text-[11px] font-semibold text-white transition-colors" style={{ backgroundColor: '#26A69A' }}
                            >
                                Понятно!
                            </button>
                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 flex-shrink-0">
                                                    <div className="relative group/move">
                                                        ...
                                                        <span className="pointer-events-none absolute top-full right-0 mt-1.5 px-2 py-1 text-[10px] font-medium text-white bg-gray-800 rounded-md whitespace-nowrap opacity-0 group-hover/move:opacity-100 transition-opacity duration-150 shadow-lg z-10">
                                                            На следующую неделю
                                                        </span>
                                                    </div>
                                                    <button
