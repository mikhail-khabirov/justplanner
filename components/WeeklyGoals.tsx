                                            ...
                                            >
                                                ...
                                                <div className="flex items-center gap-0.5 opacity-0 group-hover:opacity-100 flex-shrink-0">
                                                    <div className="relative group/move">
                                                        ...
                                                        <span className="pointer-events-none absolute bottom-full right-0 mb-1.5 px-2 py-1 text-[10px] font-medium text-white bg-gray-800 rounded-md whitespace-nowrap opacity-0 group-hover/move:opacity-100 transition-opacity duration-150 shadow-lg">
                                                            На следующую неделю
                                                        </span>
                                                    </div>
                                                    <button
